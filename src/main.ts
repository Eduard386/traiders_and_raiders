...
btnRaid.addEventListener("click", (e)=>{
  ...
  if(hit){
    ...
    const raidersSound = document.getElementById("raidersSound") as HTMLAudioElement;
    ...
    const cartSound = document.getElementById("cartSound") as HTMLAudioElement;
...
function fadeBackgroundMusic(targetVolume: number, duration: number = 1000) {
